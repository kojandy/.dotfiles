...
alias jbmm='jj bookmark move "regex:\"master|main\"" -Bt'
...
alias jgi='jj git init && (jj bookmark track master --remote=origin || jj bookmark track main --remote=origin)'
...
alias jopre='jj operation restore'
